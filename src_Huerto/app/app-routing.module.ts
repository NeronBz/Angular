...
const routes: Routes = [
  {
    ...
    loadChildren: () =>
      import('./hortaliza/hortaliza.module').then((m) => m.HortalizaModule),
  },
  {
    path: 'frutal',
    component: FrutalComponent,
    loadChildren: () =>
      import('./frutal/frutal.module').then((m) => m.FrutalModule),
  },
  {
    path: 'aromaticas',
    component: AromaticasComponent,
    loadChildren: () =>
      import('./aromaticas/aromaticas.module').then((m) => m.AromaticasModule),
  },
];
